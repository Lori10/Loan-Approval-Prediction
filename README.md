...
Note : The folder "PyCharm Code Project" includes the full project version in Pycharm using object oriented and the web app while the folder "Jupyter Notebook" includes the project version without object oriented and the web app in Jupyter Notebook.
